...
class Test_grammar(TestCase):
    ...
    def test_grouping(self):
        ...
        assert (isinstance(result, Not)
                and isinstance(result.formulas[0], Par)
                and isinstance(result.formulas[0].formulas[0], And)
                and isinstance(result.formulas[0].formulas[0].formulas[0], Proposition)
                and isinstance(result.formulas[0].formulas[0].formulas[1], Implication)
                and isinstance(result.formulas[0].formulas[0].formulas[1].formulas[0], Proposition)
                and isinstance(result.formulas[0].formulas[0].formulas[1].formulas[1], Proposition))
